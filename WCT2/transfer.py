...
class WCT2:
    """This module defines the style transfer model of the module.
    """
    def __init__(self, model_path=os.path.abspath('./WCT2/model_checkpoints'), transfer_at=['encoder', 'skip', 'decoder'], option_unpool='cat5', device='cuda:0', verbose=False):
